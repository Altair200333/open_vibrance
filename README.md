...
- [Градиентная амёба](docs/notes/gradient_amoeba.md) — canonical contour and causal impact-wave formulas, paint stack, lifecycle, tuning map, real-WAV lab, and measured recording-indicator behavior.
